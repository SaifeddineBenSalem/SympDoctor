      ...
      <form className="custom-form hero-form" onSubmit={handleSubmit} method="post" role="form">
        ...
        <div className="row gx-3">
          ...
          <div className="col-md-6 mb-3">
            <div className="input-group">
              <span className="input-group-text"><i className="bi bi-envelope"></i></span>
              <input type="email" name="confirmemail" id="confirmemail" className="form-control form-control-lg" placeholder="Confirm email" required />
            </div>
          </div>
          <div className="col-md-6 mb-3">
            <div className="input-group">
          ...
          <div className="col-md-6 mb-3">
            <div className="input-group">
              <span className="input-group-text"><i className="bi bi-lock"></i></span>
              <input type="password" name="repeatpassword" id="repeatpassword" className="form-control form-control-lg" placeholder="Repeat password" required />
            </div>
          </div>
          <div className="col-md-6 mb-3">
            <div className="input-group">
              <span className="input-group-text"><i className="bi bi-lock"></i></span>
              <select id="security_question" name="security_question" className="form-select form-select-lg" aria-label="Select Security Question" style={{height:'34px'}} required>
          ...
          <div className="col-md-6 mb-3">
            <div className="input-group">
              <span className="input-group-text"><i className="bi bi-lock"></i></span>
              <input type="text" name="securityreply" id="securityreply" className="form-control form-control-lg" placeholder="Response to security question" required />
            </div>
          </div>
