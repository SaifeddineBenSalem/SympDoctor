...
const getSymptomsOfHandledDiseases = (data) => {
  return new Promise((resolve, reject) => {
    // Python script file path
    const pythonScriptPath = path.join(__dirname, 'get_handled_diseases_symptoms.py');
...
module.exports = { getSymptomsOfHandledDiseases };
