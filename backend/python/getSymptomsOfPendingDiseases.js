...
const getSymptomsOfPendingDiseases = (data) => {
  return new Promise((resolve, reject) => {
    // Python script file path
    const pythonScriptPath = path.join(__dirname, 'get_pending_diseases_symptoms.py');
...
module.exports = { getSymptomsOfPendingDiseases };
